...
class BookingController extends Controller
{
    ...
    return view('admin.bookings.create', compact('doctors', 'rooms', 'roomId', 'timeFrom', 'timeTo'));
    }
    ...
    public function edit(Booking $booking)
    {
        ...
        return view('admin.bookings.edit', compact('booking', 'doctors', 'rooms'));
    }
